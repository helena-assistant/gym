module.exports = {
  ...
  "colação-de-grau": {
    ...
    incorrect: [
      "colação de cartaz",
      "cola de papel",
      "extraordinario aproveitamento",
      "estudante não apto",
      "como colar folhas de papel",
  ...
  "desligamento-da-universidade": {
    ...
    incorrect: [
      ...
      "qual é a sua universidade",
      "Qual professor deve assinar o contrato de estágio?",
      "estou desligado",
      "estou ligado a universidade",
  ...
  estagio: {
    ...
    incorrect: [
      "estou tentando um estágio",
      "isso é um estágio da vida",
      "estou tentando conseguir um estágio",
      "onde posso conseguir um estágio",
      "Quando posso fazer o exame especial",
      "quando sou desligado",
      "Quando acontece o exame especial",
      "Como validar minhas hrs de monitoria e tutoria",
      "como trancar uma cadeira",
      "estou em um outro estágio",
    ],
  },
  "exame-especial": {
    correct: [
    ...
    incorrect: [
      ...
      "tenho um exame marcado",
      "precido marcar um exame",
      "é um caso especial",
      "esses meninos são especiais",
  ...
  "horas-validas-de-atv": {
    ...
    incorrect: [
      "quantas horas são?",
      "o que são horas válidas",
      "consultar o calendario academico",
      "abater minhas horas de atv",
      "Entregar documentos de ATV",
      "como trancar uma cadeira",
      "quando acontecem os exames",
      "como trancar uma cadeira",
  ...
  "trancamento-de-disciplina": {
    ...
    incorrect: [
      "quero trancar um cadeado",
      "como trancar uma porta",
      "você precisa ter disciplina",
      "o trancamento das frotas marítimas é uma evidência de disciplina",
      "você gosta de cadeiras",
      "onde está sua disciplina",
      "os trancamentos ocorreram antes que houvessem as disciplinas",
      "você não passou no exame",
      "Estágio não obrigatório",
      "Onde posso pedir a segunda via da carteirinha",
    ],
